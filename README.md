...
### System Health Report
Below is an example of the automated Linux server health report generated by the script, including uptime, disk usage, memory usage, and running processes.

![Linux Server Health Report](images/health-report.png)

### Backup Script Execution
This screenshot shows the backup automation script creating timestamped `.tar.gz` archives to ensure backups are not overwritten.

![Backup Script Execution](images/backup-script.png)
---
## Technologies Used
